...
## <span style="display: flex; gap: 8px">Installation (Starlight) <Icon name="starlight" /></span>
...
## <span style="display: flex; gap: 8px">Installation (Astro) <Icon name="astro" /></span>

While the plugin is mainly developed with Starlight support in mind, it is also possible to add the Graph or Backlink components
