...
<Tabs>
	...
	<TabItem label='["!**/*", "**/*"]'>
		No files are matches, because the first rule is always matched first.
		<FileTree>
			- src
				- content
					- docs
...
<Tabs>
	...
	<TabItem label='["!https://**/*", "**/*"]'>
		Only links that are not external are matched. This is equivalent to [`includeExternalLinks: false`](/todo).
