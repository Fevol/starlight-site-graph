...
<Tabs>
	...
	<TabItem label='["header", "raw"]'>
		...
		```html ins="/link3" ins="/link4" del=/<.?header>/ del=/<.?raw>/
		<header>
			<nav>
				<a href="/link1">Header Link</a>
			</nav>
	...
	<TabItem label='[".right-sidebar"]'>
		...
		```html ins="/link1" ins="/link2" ins="/link4" del=/<.?aside.*>/
		<header>
			<nav>
				<a href="/link1">Header Link</a>
			</nav>
	...
	<TabItem label='["#footer"]'>
		...
		```html ins="/link1" ins="/link2" ins="/link3" del=/<.?div.*>/
		<header>
			<nav>
				<a href="/link1">Header Link</a>
			</nav>
...
## <Badge text="Deprecated" variant="danger" size="large" /> Ignore Starlight Links
